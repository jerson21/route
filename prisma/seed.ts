...
async function main() {
  ...
  console.log('  Admin:    admin@routeoptimizer.com / admin123');
  console.log('  Operador: operador@routeoptimizer.com / operador123');
  console.log('  Chofer:   chofer@routeoptimizer.com / chofer123');
}
